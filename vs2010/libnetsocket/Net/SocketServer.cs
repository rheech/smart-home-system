...
namespace libnetsocket.Net
{
    ...
    {
        public delegate void ExecuteCommandHandler(SocketSession session, BinaryRequestInfo requestInfo);
        public event ExecuteCommandHandler OnExecuteCommand;
        ...
        protected override void ExecuteCommand(SocketSession session, BinaryRequestInfo requestInfo)
        {
            ...
            {
                OnExecuteCommand(session, requestInfo);
            }
        }
    }
}
