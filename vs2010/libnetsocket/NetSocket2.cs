...
namespace libnetsocket
{
    ...
    public class NetSocket2
    {
        ...
        public delegate byte[] cbDataArrival(EndPoint remoteEP, byte[] data);
        ...
        public NetSocket2(ProtocolType protocol)
        {
            Initialize(protocol);
        }
        ...
        public void Close()
        {
            if (_sock.Connected)
            {
                ...
                //_sock.BeginDisconnect(true, new AsyncCallback(OnCloseCallBack), _sock);
            }
